...
def task_detail(request, task_id):
    if request.method == 'GET':
        ...
        try:
            task = get_object_or_404(Task, pk=task_id)#condicional predeterminado de django
            form = TaskForm(request.POST, instance=task)#va a recibir todos los datos que tiene post
